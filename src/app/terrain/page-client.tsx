                      ...
                      <div className="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-[0_4px_16px_rgba(0,0,0,0.06)] hover:-translate-y-0.5 transition-all duration-300 border border-[#E5E7EB]">
                        <div className="relative h-48 overflow-hidden">
                          {listing.images?.[0] ? (
                            ...
                            <div className="w-full h-full bg-[#FFF4EC] flex items-center justify-center">
                              <Square className="w-10 h-10 text-[#6B7280]" />
                            </div>
                          )}
                          <span className="absolute top-3 left-3 bg-[#E8630A] text-white text-xs px-2 py-1 rounded">
                            {listing.terrain_type || 'Terrain'}
                          </span>
                          {listing.title_deed && (
                            <span className="absolute top-3 right-12 bg-[#E8630A] text-white text-xs px-2 py-1 rounded">
                              Titre foncier
                            </span>
                          )}
                        ...
                        <div className="p-4">
                          <h3 className="font-semibold text-gray-900 group-hover:text-[#E8630A] transition-colors line-clamp-1 mb-1">
                            {listing.title}
                          </h3>
                          ...
                          <div className="flex items-center gap-3 text-sm text-gray-600 mb-2">
                            ...
                            {listing.latitude && listing.longitude && (
                              <span className="text-[#E8630A]">GPS</span>
                            )}
                          </div>
                          <div className="flex items-center justify-between">
                            <span className="text-lg font-bold text-[#E8630A]">
