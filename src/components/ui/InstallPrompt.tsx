          ...
          <div className="flex items-center justify-between max-w-lg mx-auto">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-green-100 text-xs">{t.banner.subtitle}</p>
              </div>
            </div>
          ...
          <div className="bg-gray-50 rounded-xl p-4">
            ...
            <ol className="text-sm text-gray-700 space-y-2">
              <li className="flex items-center gap-2">
                <span className="w-5 h-5 bg-green-600 text-white rounded-full text-xs flex items-center justify-center">1</span>
                {t.ios.step1} <Share className="w-4 h-4 inline" />
              </li>
              <li className="flex items-center gap-2">
                <span className="w-5 h-5 bg-green-600 text-white rounded-full text-xs flex items-center justify-center">2</span>
